...
if (!ref) {
    const latestRelease = await fetch("https://api.github.com/repos/Nasafrasa/ReMapperParticleSystem/releases/latest", {
        headers: {
...
// now copy to path
const ignoredFiles = ["setup", ".git", "README.md", "LICENSE"]
...
console.log(`Successfully setup ReMapper Particle System at ${destFolder}`)